        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Detail Anak - <?php echo $_GET['idd'] ?></li>
                </ol>
            </div>
        </div>
    </div>
                    ...
                    <div class="card-body" style="overflow:auto">
                        <?php
                            $q1 = mysqli_query($koneksi, "SELECT *
                                ...
                                ON orang_tua.No_KK = anak.No_KK
                                INNER JOIN jenis_kelamin
                                ON jenis_kelamin.Id_Jenis_Kelamin = anak.Id_Jenis_Kelamin
                                INNER JOIN kabupaten
                                ON kabupaten.Id_Kabupaten = anak.Tempat_Lahir
                                WHERE anak.NIK_Anak = '$_GET[idd]'");
                        ...
                        <table id="example2" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <td width=70%>
                                    <?php
                                        $tg = $qdata['Tanggal_Lahir'];
                                        $sts = 0;
                                        include('../date_conv.php');
                                    ?>
                                    <?php echo $qdata['Kabupaten']?>, <?php echo $tanggal ?>
                                </td>
                            </tr>
                            <tr>
                                <td width=30%>No. KK</td>
                                <td width=70%><?php echo $qdata['No_KK'] ?></td>
                            </tr>
                            <tr>
                                <td width=30%>Nama Ayah</td>
                                <td width=70%><?php echo $qdata['Nama_Ayah'] ?></td>
                            </tr>
                            <tr>
                                <td width=30%>Nama Ibu</td>
                                <td width=70%><?php echo $qdata['Nama_Ibu'] ?></td>
                            </tr>
                        </table>
                    </div>
                    <div class="card-body" style="overflow:auto">
                        <table id="example1" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th width="25%">
                                        Jadwal
                                        <input class="form-control" type="search" id="co0" onkeyup="search(0)" placeholder="Cari Jadwal...">
                                    </th>
                                    <th width="20%">
                                        Total Pencatatan
                                        <input class="form-control" type="search" id="co1" onkeyup="search(1)" placeholder="Cari Total Pencatatan...">
                                    </th>
                                    <th width="20%">
                                        Status Gizi
                                        <input class="form-control" type="search" id="co2" onkeyup="search(2)" list="op_gz" placeholder="Cari Status Gizi...">
                                        <datalist id="op_gz">
                                            <?php
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $q2 = mysqli_query($koneksi, "SELECT *
                                        ...
                                        WHERE catatan_pemeriksaan.NIK_Anak = '$_GET[idd]'");
                                ...
                                <?php echo "<tr id='change_form".$no."' style='display:none'>"; ?>
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <td><?php echo "<input disabled type='text' class='form-control' name='tp' value='".$nom['Total_Pencatatan']."'>"; ?></td>
                                        <td><?php echo "<input disabled type='text' class='form-control' name='gz' value='".$nom['Status_Gizi']."'>"; ?></td>
                                        <td align=center>
                                    ...
                                    <?php
                                        ...
                                        if (isset($_POST[$ch])){
                                            $sql=$koneksi->query("UPDATE `catatan_pemeriksaan`
                                                SET `Id_Jadwal` = '$_POST[jdw]'
                                                WHERE `Id_Catatan_Pemeriksaan` = '$nom[Id_Catatan_Pemeriksaan]'
                                            ");
                                            if($sql){
                                                echo "<script>window.location = 'index.php?page=detail_anak&idd=".$_GET['idd']."'</script>";
                                            }else{
                                                echo "<script>alert('Proses gagal'); window.location = 'index.php?page=detail_anak&idd=".$_GET['idd']."'</script>";
                                            }
                                        }
                                    ?>
                                </tr>
                                    ...
                                    ?>
                                        ...
                                        <?php echo "<tr id='delete".$no."' style='display: none;'>"; ?>
                                            <td colspan=5 align=center>
                                                ...
                                                <?php echo "<a class='btn btn-del' style='width: 45%' href='hapus.php?id=".$nom['Id_Catatan_Pemeriksaan']."&idd=".$_GET['idd']."&type=detail_anak'>Ya</a>"; ?>
                                            </td>
                                        </tr>
                                    <?php }?>
                                </tr>
                                            ...
                                            <form method="post" enctype="multipart/form-data">
                                                ...
                                                <td>
                                                    <select class="form-control" name="jdw">
                                                        ...
                                                        ?>
                                                        <option value=<?php echo $noy['Id_Jadwal']?>> <?php echo $noy['Nama_Posyandu'];?> - <?php echo $noy['Tanggal'];?>  </option>
                                                        <?php }?>
                                                    </select>
                                                </td>
                                                <td><?php echo "<input disabled type='text' class='form-control' name='tp' value='0'>"; ?></td>
                                                <td><?php echo "<input disabled type='text' class='form-control' name='gz' value='Belum Diperiksa'>"; ?></td>
                                                <td align=center>
                                            ...
                                            <?php 
                                                if (isset($_POST['insert'])){
                                                    $sql=$koneksi->query("INSERT INTO `catatan_pemeriksaan`(Id_Catatan_Pemeriksaan, NIK_Anak, Id_Jadwal, Total_Pencatatan, Total_Layanan, Id_Status_Gizi) 
                                                        VALUES('$IDD', '$_GET[idd]', '$_POST[jdw]', 0, 0, 'SG006')
                                                    ");
                                                    if($sql){
                                                        echo "<script>window.location = 'index.php?page=detail_anak&idd=".$_GET['idd']."'</script>";
                                                    }else{
