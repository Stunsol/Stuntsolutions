        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"><a href="index.php?page=jadwal">Jadwal</a></li>
                    ...
                    <div class="card-body" style="overflow:auto">
                        <?php
                            $q1 = mysqli_query($koneksi, "SELECT *
                                ...
                                WHERE jadwal.Id_Jadwal = '$_GET[idd]'");
                        ...
                        <table id="example2" class="table table-bordered table-striped">
                            ...
                            <tr>
                                <td width=30%>Jam</td>
                                <td width=70%><?php echo $qdata['Jam'] ?></td>
                            </tr>
                            <tr>
                                <td width=30%>Tempat</td>
                                <td width=70%><?php echo $qdata['Tempat'] ?></td>
                            </tr>
                        </table>
                    </div>
                    <div class="card-body" style="overflow:auto">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $q2 = mysqli_query($koneksi, "SELECT *
                                        ...
                                        ON jadwal_pemeriksaan.Id_Jenis_Pemeriksaan = jenis_pemeriksaan.Id_Jenis_Pemeriksaan
                                        WHERE jadwal_pemeriksaan.Id_Jadwal = '$_GET[idd]'");
                                ...
                                <?php echo "<tr id='change_form".$no."' style='display:none'>"; ?>
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <td align=center>
                                            ...
                                            <?php echo "<button type='submit' style='width:45%' name='update".$_GET['idd']."&".$nom['Id_Jenis_Pemeriksaan']."' class='btn btn-sa'>Simpan</button>"; ?>
                                        </td>
                                    </form>
                                    <?php
                                        $ch = "update".$_GET['idd']."&".$nom['Id_Jenis_Pemeriksaan'];
                                        if (isset($_POST[$ch])){
                                            $sql=$koneksi->query("UPDATE `jadwal_pemeriksaan`
                                                SET `Id_Jenis_Pemeriksaan` = '$_POST[jns]'
                                                WHERE `Id_Jadwal` = '$_GET[idd]' AND `Id_Jenis_Pemeriksaan` = '$nom[Id_Jenis_Pemeriksaan]'
                                            ");
                                            if($sql){
                                                echo "<script>window.location = 'index.php?page=jadwal_pemeriksaan&idd=".$_GET['idd']."'</script>";
                                            }else{
                                                echo "<script>alert('Proses gagal'); window.location = 'index.php?page=jadwal_pemeriksaan&idd=".$_GET['idd']."'</script>";
                                            }
                                        }
                                    ?>
                                </tr>
                                    ...
                                    ?>
                                        ...
                                        <?php echo "<tr id='delete".$no."' style='display: none;'>"; ?>
                                            <td colspan=5 align=center>
                                                ...
                                                <?php echo "<a class='btn btn-del' style='width: 45%' href='hapus.php?idc=".$_GET['idd']."&idj=".$nom['Id_Jenis_Pemeriksaan']."&type=jadwal_pemeriksaan'>Ya</a>"; ?>
                                            </td>
                                        </tr>
                                    <?php }?>
                                </tr>
                                        ...
                                        <tr id="add_form" style="display: none">
                                            ...
                                            <?php 
                                                if (isset($_POST['insert'])){
                                                    $sql=$koneksi->query("INSERT INTO `jadwal_pemeriksaan`(Id_Jadwal, Id_Jenis_Pemeriksaan) 
                                                        VALUES('$_GET[idd]', '$_POST[jns]')
                                                    ");
                                                    if($sql){
                                                        echo "<script>window.location = 'index.php?page=jadwal_pemeriksaan&idd=".$_GET['idd']."'</script>";
                                                    }else{
