                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            <thead> <!--Judul Tabel-->
                                <tr>
                                    ...
                                    <th width="35%">
                                        Kelurahan
                                        <input list="op_kel" class="form-control" type="search" id="co0" onkeyup="search(0)" placeholder="Cari Kelurahan...">
                                        <datalist id="op_kel">
                                            <?php
                                    ...
                                    <th width="35%">
                                        Kecamatan
                                        <input list="op_kec" class="form-control" type="search" id="co1" onkeyup="search(1)" placeholder="Cari Kecamatan...">
                                        <datalist id="op_kec">
                                            <?php
                            ...
                            <tbody>
                                    ...
                                    ?>
                                        ...
                                        <?php echo "<tr id='delete".$no."' style='display: none;'>"; ?>
                                            <td colspan=4 align=center>
                                                ...
                                                <?php echo "<a class='btn btn-del' style='width: 45%' href='hapus.php?id=".$nom['Id_Kelurahan']."&type=kelurahan'>Ya</a>"; ?>
                                            </td>
                                        </tr>
                                    <?php }?>
								</tr>
                                ...
                                ?>    
                                        <?php
                                            $cmax = mysqli_query($koneksi, "SELECT max(Id_Kelurahan) as bat FROM `kelurahan`");
                                            $nox = mysqli_fetch_array($cmax);
                                            $IDD = $nox['bat'];
                                            $ord = (int) substr($IDD, 3, 3);
                                            $ord++;
                                            $IDD = "Kel".sprintf("%03s", $ord);
                                        ?>
                                        <tr id="add_button">
                                        ...
                                        <tr id="add_form" style="display: none">
                                            <form method="post" enctype="multipart/form-data">
                                                ...
                                                <td><input type="text" class="form-control" placeholder="Kelurahan" name="je"></td>
                                                <td>
                                                    <select class="form-control" name="lay">
                                                        <?php
                                                        $no = 0;
                                                        $query3 = mysqli_query($koneksi, "SELECT * FROM `kecamatan`");
                                                        while ($noa = mysqli_fetch_array($query3)){
                                                        ?>
                                                        <option value=<?php echo $noa['Id_Kecamatan']?>> <?php echo $noa['Kecamatan'];?> </option>
                                                        <?php }?>
                                                    </select>
                                                </td>
                                                <td align=center>
                                            ...
                                            <?php 
                                                if (isset($_POST['insert'])){
                                                    $sql=$koneksi->query("INSERT INTO `kelurahan`(Id_Kelurahan, Kelurahan, Id_Kecamatan) 
